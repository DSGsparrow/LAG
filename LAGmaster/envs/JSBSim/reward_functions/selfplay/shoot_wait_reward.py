...
class SelfPlayShootWaitReward(BaseRewardFunction):
    ...
    def __init__(self, config):
        ...
        self.max_reward_distance = 20000  # 米
        self.min_reward_distance = 30000  # 米
    ...
    def get_reward(self, task, env, agent_id):
        reward = 0.0
        a = env.agents[agent_id].check_missile_warning()
        b = env.agents[agent_id].check_missile_launching()
