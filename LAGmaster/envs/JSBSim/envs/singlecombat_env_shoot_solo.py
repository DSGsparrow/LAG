...
from ..tasks import SingleCombatTask, SingleCombatDodgeMissileTask, HierarchicalSingleCombatDodgeMissileTask, \
    ...
    HierarchicalSingleCombatShootMissileBackTask, HierarchicalSingleCombatShootMissileSoloTask
...
class SingleCombatEnvShootSolo(BaseEnv):
    """
    ...
    def load_task(self):
        ...
        elif taskname == 'hierarchical_singlecombat_shoot_solo':
